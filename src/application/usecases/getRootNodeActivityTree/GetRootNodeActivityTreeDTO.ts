...
export const GetRootNodeActivityTreeRequestSchema = z.object({
    activityId: z.string().uuid()
})

export const GetRootNodeActivityTreeResponseSchema = z.object({
    id: z.string().uuid(),
...
export type GetRootNodeActivityTreeResponseDTO = z.input<typeof GetRootNodeActivityTreeResponseSchema>
