...
import { DeleteOrganizationOnCascadeController } from "./DeleteOrganizationOnCascateController"
...
const deleteOrganizationOnCascadeUseCase = new DeleteOrganizationOnCascadeUseCase(prismaDeleteRecordInterationRepository);
const deleteOrganizationOnCascadeController = new DeleteOrganizationOnCascadeController(deleteOrganizationOnCascadeUseCase);

export { deleteOrganizationOnCascadeUseCase, deleteOrganizationOnCascadeController }